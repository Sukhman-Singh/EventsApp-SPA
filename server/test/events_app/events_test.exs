defmodule EventsApp.EventsTest do
  ...
  describe "events" do
    ...
    @valid_attrs %{body: "some body", date: "2010-04-17T14:00:00Z", name: "some name"}
    @update_attrs %{body: "some updated body", date: "2011-05-18T15:01:01Z", name: "some updated name"}
